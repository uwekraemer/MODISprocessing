...
from waqss_processing.nasa.modis.seadas_processing.conf.params import west_lon_large_l3 as lon_min, east_lon_large_l3 as lon_max
from waqss_processing.nasa.modis.seadas_processing.conf.params import south_lat_large_l3 as lat_min, north_lat_large_l3 as lat_max
from waqss_processing.nasa.modis.seadas_processing.conf.params import l3_grid_cell_size, _site
from waqss_processing.nasa.modis.seadas_processing.shared.utilities import getDOY, ensureTrailingSlash, exit_on_empty_list
from waqss_processing.nasa.modis.seadas_processing.conf.paths import modisL3_TSMBasePath, beam_410BinDir as beamBinDir, l3binningDir
...
modisL2_TSMBasePath_ns = '/mnt/disk1/MODISA/L2_TSM/STD/NorthSea/'
modisL2_TSMBasePath_bs = '/mnt/disk2/MODISA/L2_TSM/STD/BalticSea/'
...
outputProductPath = modisL3_TSMPath + 'test_bin27_MODISA_DeM' + '_' + back_date + '.dim'
...
l3binningConf = l3binningDir + 'l3_large_' + str(_year) + str(_doy) + '.conf'
...
request_init_block += '        <Parameter name="band_name.4" value="pic" />\n'
request_init_block += '        <Parameter name="bitmask.4" value="pic &gt; 0.0" />\n'
...
request_init_block += '        <Parameter name="band_name.5" value="poc" />\n'
request_init_block += '        <Parameter name="bitmask.5" value="poc &gt; 0.0" />\n'
request_init_block += '        <Parameter name="binning_algorithm.5" value="Arithmetic Mean" />\n'
request_init_block += '        <Parameter name="weight_coefficient.5" value="1.0" />\n'
request_init_block += '        <Parameter name="band_name.6" value="par" />\n'
request_init_block += '        <Parameter name="bitmask.6" value="par &gt; 0.0" />\n'
request_init_block += '        <Parameter name="binning_algorithm.6" value="Arithmetic Mean" />\n'
request_init_block += '        <Parameter name="weight_coefficient.6" value="1.0" />\n'
request_init_block += '        <Parameter name="band_name.7" value="Zeu_lee" />\n'
request_init_block += '        <Parameter name="bitmask.7" value="Zeu_lee &gt; 0.0" />\n'
request_init_block += '        <Parameter name="binning_algorithm.7" value="Arithmetic Mean" />\n'
request_init_block += '        <Parameter name="weight_coefficient.7" value="1.0" />\n'
