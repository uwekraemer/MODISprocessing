...
srcDir = '/fs14/EOservices/InputPool/MERIS/RR/backlog/ballastwater/'

#destDir = '/fs14/EOservices/OutputPool/MERIS/RR/WAQS-IPF/daily-merged/'
destDir ='/fs14/EOservices/InputPool/MERIS/RR/backlog/ballastwater/daily-merged/'
...
for date_int in range(int(start_date), int(end_date)+1):
    ...
    for region in ['all']: 
        if region=="all":
            regiondestID= '_all_'
            west_lon = "-4.0"           # lon_min
            north_lat = "65.85"          # lat_max
            east_lon = "30.333334"           # lon_max
            south_lat = "48.55"          # lat_min
