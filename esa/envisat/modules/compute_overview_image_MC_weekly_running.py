#!/usr/bin/env python
# -*- coding: latin-1 -*
# file: compute_overview_image_MC_weekly_running.py
...
#computes monthly overview of images MC weekly
...
print("\n*****************************************************************")
print(" Script \'compute_overview_image_MC_weekly_running.py\' at work... ")
print("*****************************************************************\n")
...
print("computing overview images (MC weekly) for " + month)
...
hiresImagesDir = imagesDir + 'weekly/hires/'
quickLooksDir  = imagesDir + 'weekly/quicklooks/'
thumbsDir      = imagesDir + 'weekly/thumbs/'
...
for a in range(productNo):
    ...
    outputFileString = projectsDir + month + '_MC_weekly' + regiondestID + product + '.jpg'
