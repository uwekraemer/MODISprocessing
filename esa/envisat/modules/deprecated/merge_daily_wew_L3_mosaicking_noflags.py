#!/usr/bin/env python
# -*- coding: latin-1 -*
# file: merge_daily_wew_L3_mosaicking_noflags.py
...
def printUsage():
    print("Usage: merge_daily_wew_L3_mosaicking_noflags.py region back_day")
...
print("\n**************************************************************")
print(" Script \'merge_daily_wew_L3_mosaicking_noflags.py\' at work... ")
print("**************************************************************\n")
...
if sys.argv[1]=="NorthSea":
    ...
    l3mosaickingConf   = l3mosaickingHome + 'l3mosaicWeWNorthSeaSeaDaily.xml'
    ...
    l3mosaickingConf   = l3mosaickingHome + 'l3mosaicWeWBalticSeaDaily.xml'
    ...
    l3mosaickingConf   = l3mosaickingHome + 'l3mosaicWeWEstoniaDaily.xml'
else:
    regiondestID= '_uk_'
    ...
    l3mosaickingConf   = l3mosaickingHome + 'l3mosaicWeWUnitedKingdomDaily.xml'
...
request_init_block = request_init_block +     '    <Request type=\"MOSAIC\">\n'
request_init_block = request_init_block +     '        <Parameter name=\"west_lon\" value=\"'+west_lon+'\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"north_lat\" value=\"'+north_lat+'\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"east_lon\" value=\"'+east_lon+'\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"south_lat\" value=\"'+south_lat+'\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"projection_name\" value=\"Geographic Lat/Lon\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"projection_parameters\" value=\"\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"pixel_size_x\" value=\"'+pixel_size_x+'\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"pixel_size_y\" value=\"'+pixel_size_y+'\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"orthorectification\" value=\"false\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"orthorectification_dem\" value=\"GETASSE30\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"algal_concentration.expression\" value=\"algal_concentration\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"yellow_subs_absorption.expression\" value=\"yellow_subs_absorption\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"total_susp_concentration.expression\" value=\"total_susp_concentration\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"condition_operator\" value=\"OR\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"log_to_output\" value=\"false\" />\n'
request_init_block = request_init_block +     '        <Parameter name=\"log_prefix\" value=\"mosaic\" />\n'
...
# jedes Band exponieren:
for item in proc_list:
    l3BandArithBatchParams  = "algal_concentration \"algal_2==5.0?0:exp10(algal_2)\" total_susp_concentration \"total_susp==5.0?0:exp10(total_susp)\" yellow_subs_absorption \"yellow_subs==5.0?0:exp10(yellow_subs)\""
    l3BandArithBatchCommand = l3BandArithBatchScript + " " + srcDir + proc_list[item] + " " + l3BandArithBatchParams
    os.system(l3BandArithBatchCommand)

# Jetzt geht's los:
output_filename= destDir + previous_day + regiondestID + "wac_wew-noflags_1200.dim"
...
print("\n**************************************************************")
print(" Script \'merge_daily_wew_L3_mosaicking_noflags.py\' finished. ")
print("**************************************************************\n")
