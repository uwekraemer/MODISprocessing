...
request_init_block = request_init_block +     '        <Parameter name="radiance_1.expression" value="radiance_1" />\n'
request_init_block = request_init_block +     '        <Parameter name="radiance_2.expression" value="radiance_2" />\n'
request_init_block = request_init_block +     '        <Parameter name="radiance_3.expression" value="radiance_3" />\n'
request_init_block = request_init_block +     '        <Parameter name="radiance_4.expression" value="radiance_4" />\n'
request_init_block = request_init_block +     '        <Parameter name="radiance_5.expression" value="radiance_5" />\n'
request_init_block = request_init_block +     '        <Parameter name="radiance_6.expression" value="radiance_6" />\n'
request_init_block = request_init_block +     '        <Parameter name="radiance_7.expression" value="radiance_7" />\n'
request_init_block = request_init_block +     '        <Parameter name="radiance_12.expression" value="radiance_12" />\n'
