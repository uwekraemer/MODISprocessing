...
def printUsage():
    print("Usage: make_world_mosaic.py backDay")
...
try:
    ...
    if (argc == 1):          # the program was called without parameters
        print("\nDay specifier is missing!\n")
        sys.exit(1)
    else:
        if (sys.argv[1] < 1):
            print("\nDay specifier useless!\n")
            sys.exit(1)    
except:
    printUsage()
...
print("\n******************************************")
print(" Script \'make_world_mosaic.py\' at work... ")
print("******************************************\n")
...
# Configure the day to use for mosaicking relative to the actual date (1 = yesterday, 2 = the day before yesterday...)
back_days = sys.argv[1]
print(back_days)

arrival_day=get_date_string(get_float_day(int(back_days)))
...
dataDir=dimap_output_filename[:-2] + 'ata'
...
print("\n******************************************")
print(" Script \'make_world_mosaic.py\' finished. ")
print("******************************************\n")
