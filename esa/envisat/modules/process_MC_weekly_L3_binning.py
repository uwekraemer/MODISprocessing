...
print("\n*****************************************************")
print(" Script \'process_MC_weekly_L3_binning.py\' at work... ")
print("*****************************************************\n")
...
# Jetzt geht's los:
output_filename= destDir + previous_days[6]+"_"+previous_days[0]+ regiondestID + "wac_acr_1200.dim"
...
print("\n*****************************************************")
print(" Script \'process_MC_weekly_L3_binning.py\' finished. ")
print("*****************************************************\n")
