...
configFilePath = configDir + 'zipDirConfigEnvisat.ini'
config = ConfigParser()
...
# 
# dest_dirs = ['/ftp/waqs-bsh/MERIS-RR/running_weeklymean/', \
#             '/ftp/waqs-bsh/MERIS-RR/monthly_MC/', \
#             '/ftp/waqs-bsh/MERIS-RR/daily_IPF/', \
#             '/ftp/waqs-bsh/MERIS-RR/daily_FUB/', \
#             '/ftp/waqs-bsh/MERIS-RR/daily_MC/', \
#             '/ftp/waqs-bsh/SST/']
#===============================================================================
...
zip_call = zipping_script + ' ' + str(dir_index)
system(zip_call)
sync_weekly_bas_sst_prods_call = rsync_header_string + src_dirs[dir_index] + '*_baltic_sea_sst_aatsr_* uwe@10.1.0.2:' + dest_dirs[dir_index] + 'BalticSea/'
print sync_weekly_bas_sst_prods_call
system(sync_weekly_bas_sst_prods_call)
sync_weekly_nos_sst_prods_call = rsync_header_string + src_dirs[dir_index] + '*_north_sea_sst_aatsr_* uwe@10.1.0.2:' + dest_dirs[dir_index] + 'NorthSea/'
print sync_weekly_nos_sst_prods_call
system(sync_weekly_nos_sst_prods_call)
