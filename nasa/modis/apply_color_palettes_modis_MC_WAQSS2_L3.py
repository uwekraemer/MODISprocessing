...
def printUsage():
    print("Usage: apply_color_palettes_modis_MC_WAQSS2_L3 backDay")
...
print("\n****************************************************************")
print(" Script \'apply_color_palettes_modis_MC_WAQSS2_L3.py\' at work... ")
print("****************************************************************\n")
...
startDay    = get_date_string(get_float_day(backDay + 6))
endDay      = get_date_string(get_float_day(backDay))
...
imagesDir      = '/fs14/EOservices/OutputPool/quicklooks/WAQS-MC-MODIS/weekly_png/'             # bcserver7
...
#TODO: complete when all bands are available
#numBands = 4
...
for a in range(listSize):
    for item in srcList:
        if not item.endswith('.dim') or not item.startswith(rangeString) or item.find('_est_')>0:
...
print("\n****************************************************************")
print(" Script \'apply_color_palettes_modis_MC_WAQSS2_L3.py\' finished.  ")
print("****************************************************************\n")
