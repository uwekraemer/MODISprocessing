...
# basic directories
baseDir        = '/fs14/EOservices/OutputPool/MODIS/WAQS-MC/'                          # bcserver7
srcDir         = baseDir + 'weekly/'
pconvertHome   = '/home/uwe/tools/pconvert/'                                           # bcserver7
pconvertScript = pconvertHome + 'pconvert.sh'                                          # bcserver7
imagesDir      = '/fs14/EOservices/OutputPool/quicklooks/WAQS-MC-MODIS/weekly/'        # bcserver7
...
print(chlLegend, os.path.exists(chlLegend))

logosOverlay     = pconvertHome    + 'BC-ACRI-NASA-MODIS-WAQSS_grey.jpg'
...
for item in srcList:
    ...
    for a in range(numBands):
        ...
        geometryString0 = '+' + str(1045+xOffset) + '+' + str(1037+yOffset)
        imOverlayCommand0 = imComposite + ' -geometry ' + geometryString0 + ' -quality 90 ' +  legends[a] + ' ' + rawImageName + ' ' + rawImageName
        print(imOverlayCommand0)
        os.system(imOverlayCommand0)
        
        # now the metadata annotation
#        geometryString1 = '0x0+' + str(1045+xOffset) + '+' + str(1024+yOffset)
        geometryString1 = '+' + str(1045+xOffset) + '+' + str(1024+yOffset)
        imAnnotateCommand = imConvert + ' -font /usr/share/fonts/truetype/VeraBd.ttf -pointsize 16 -fill black -annotate ' + geometryString1 + ' \'Weekly mean:  ' + startDay + ' ' +'to ' + endDay + '\' ' + rawImageName + ' ' + rawImageName
